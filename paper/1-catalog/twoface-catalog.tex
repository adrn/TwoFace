...
\todo{here:} \figurename~\ref{fig:logg-teff-p-e} ...
...
\end{center}
\caption{%
\textit{Top:} Inferred orbital period and eccentricity for all systems with unimodal posterior samplings from \thejoker.
\textit{Bottom left:}
\textit{Bottom Right:}
...
\todo{Discuss tidal circ and mention worth pursuing. Don't say we are going to
do this. Emphasize that the data contain information about those things.}

\todo{High-mass companions}
