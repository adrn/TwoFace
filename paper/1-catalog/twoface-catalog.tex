...
number of visits that pass the above quality cuts: \todo{92}\% of the stars in
...
\todo{Comment on things we could do with these samples hierarchical
inference...}
