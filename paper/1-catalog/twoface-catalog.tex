...
samplings.
We report maximum \textit{a posteriori} sample values for the orbital
...
\tablename~\ref{tbl:highK-unimodal} contains descriptions and units for all columns in the high-$K$, unimodal sample catalog.
