...
high-confidence companions while similarly minimizing an estimated
false-positive rate.

\todo{False-positive estimate using the null control sample.}
...
$K$.
\figurename~\ref{fig:} shows distributions of percentiles in $\ln K$ computed
for all stars with posterior samplings from \thejoker.
\todo{percentiles figure}
