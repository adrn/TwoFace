...
multiple star systems rather than as solitary stars
(\citealt{ragavhan,tokovinin,todo}).
...
\todo{Planetary systems are interesting because...yadda yadda}
...
\todo{should we name ``stars with companions'' something like ``stellar
systems''?}
