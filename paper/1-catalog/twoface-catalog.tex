...
period samplings using primary masses from \citet{Ness:2015}.
Upper dashed line shows the $M_{2, \textrm{min}} = M_1$ line, and lower dashed
...
Three interesting systems are immediately obvious: two systems with bimodal
period samplings in which both period modes put the minimum companion mass below
the Hydrogen-burning limit, and one system in which $M_{2, \textrm{min}} > M_1$.
...
\subsubsection{2M04582049+2232000}
% BD candidate


\subsubsection{2M20130687+2044173}
% BD candidate


\subsubsection{2M01231070+1801407}
% NS/BH candidate
