...
APW: Opening sentence: If we see RV changes, there must be binaries!
Can we infer binary populations from bad data?
...
We make our posterior samplings under the following assumptions:
\begin{description}
\item[foo] whatevs
\item[bar] and more
\end{description}
