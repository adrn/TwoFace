...
star (in the case, say, of SB1 stars), do we reliably obtain posterior
...
computationally expensive but probabilistically righeous: It delivers
...
posterior pdfs overy binary-system properties, many of which will
...
posterior information about the full population statistics.

HOGG: Why are \RC\ or \RGB\ stars ideal candidates? It has to do with the
unlikelihood that they will be SB2. Also: abundances! Also: masses!
Also: distances! and so on.!
